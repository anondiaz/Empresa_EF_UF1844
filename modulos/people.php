...
<a href="index.php?formulario=modificar&nombre=<?= $fila['nombre_persona']?>&apellidos=<?= $fila['apellido_persona']?>&email=<?= $fila['email']?>&departamento=<?= $fila['departamento']?>&id_departamento=<?= $fila['id_departamento']?>">
